...
struct Animal {
  ...
  //but we have to share sth betweeen classes
  //the data in this class are common to all the other classes
  unsigned int age;
  double weight;
...
struct Snake {
  //object composition: put an object inside another class --> has a 
  Animal _animal;
  bool dangerous;
