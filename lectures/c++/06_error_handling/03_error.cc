...
#include "ap_error.h" //macro: advanced programming error
...
double square_root(const double d) {
  ...
  AP_ERROR(d >= 0 && d <= 50, Square_root_invalid)
      << "In our library the argument must be positive and less or equal than "
         "50.\n";
  //only codition and additional message
...
//usefull to write in the macro where the exception happened
//we would like to turn on and off the checks
