...
//if we don't specify a constructor, the compiler generates a 
//default constructor
//constructor generated by the compiler has empty body 
//and no parameters
...
struct Foo {
  ...
  //the defafault constructor doesn't need parameters
...
//parametrized constructor: pass arguments to the constructor
